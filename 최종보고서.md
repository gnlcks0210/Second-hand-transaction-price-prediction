...
![월별 대여량 추이](images/monthly-trend.png)
...
![대여 반납 불균형](./images/rental-return-imbalance.png)
...
![변수 중요도](./images/feature-importance.png)
...
![클러스터별 분포](./images/cluster-distribution.png)
...
![모델 성능](./images/model-performance.png)
...
![핫플레이스 지도](./images/hotspot-map.jpg)
